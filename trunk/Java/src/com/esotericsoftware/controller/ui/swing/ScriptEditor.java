...
public class ScriptEditor extends EditorPanel<Script> {
	...
	public ScriptEditor (UI owner) {
		...
		provider.addCompletion(new ShorthandCompletion(provider, "S", "device.set(\"start\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "G", "device.set(\"guide\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "BK", "device.set(\"back\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "A", "device.set(\"a\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "B", "device.set(\"b\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "X", "device.set(\"x\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "Y", "device.set(\"y\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "U", "device.set(\"up\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "D", "device.set(\"down\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "L", "device.set(\"left\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "R", "device.set(\"right\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RT", "device.set(\"rightTrigger\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LT", "device.set(\"leftTrigger\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RSH", "device.set(\"rightShoulder\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LSH", "device.set(\"leftShoulder\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RST", "device.set(\"rightStick\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LST", "device.set(\"leftStick\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RX", "device.set(\"rightStickX\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RY", "device.set(\"rightStickY\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RXY", "device.set(\"rightStick\", 1, 1)"));
		provider.addCompletion(new ShorthandCompletion(provider, "LX", "device.set(\"leftStickX\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LY", "device.set(\"leftStickY\", getPayload())"));
