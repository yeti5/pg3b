...
public class ScriptEditor extends EditorPanel<Script> {
	...
	public ScriptEditor (PG3BUI owner) {
		...
		provider.addCompletion(new ShorthandCompletion(provider, "RSH", "pg3b.set(\"rightShoulder\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LSH", "pg3b.set(\"leftShoulder\", getPayload())"));
		...
		provider.addCompletion(new ShorthandCompletion(provider, "RX", "pg3b.set(\"rightStickX\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RY", "pg3b.set(\"rightStickY\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "RXY", "pg3b.set(\"rightStick\", 1, 1)"));
		provider.addCompletion(new ShorthandCompletion(provider, "LX", "pg3b.set(\"leftStickX\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LY", "pg3b.set(\"leftStickY\", getPayload())"));
		provider.addCompletion(new ShorthandCompletion(provider, "LXY", "pg3b.set(\"leftStick\", 1, 1)"));
